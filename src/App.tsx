  ...
  return <>
    ...
    <div className="workspace">
      ...
      <main>
        ...
        {isHome && featured && <section className="featured"><div className="featured-copy"><div className="featured-label"><Sparkles size={14} />从这里开始<span>EDITOR’S PICK</span></div><h2>{featured.title}</h2><p>{featured.subtitle}。{featured.summary.split('。')[0]}。</p><div className="featured-bottom"><a href={paperUrl(featured)} className="primary-link">阅读解析<ArrowRight size={16} /></a><span><Clock3 size={13} />{featured.readingMinutes} 分钟阅读</span>{featured.demo && <span className="demo-label">示例报告</span>}</div></div><div className="featured-art"><span className="art-caption">THE IDEAS THAT CONNECT EVERYTHING</span><Diagram kind={featured.visual} /><span className="art-bottom">01 — A NEW WAY TO PAY ATTENTION</span></div></section>}
